//! Command-line interface utilities for the `fnsd` daemon.
...
pub enum RootCommand {
    /// Starts the Fusion daemon.
    Start {
        /// The path used to store all `fnsd`-related data and configuration.
        /// If unset, defaults to ~/.fusion/network_data/node0/fnsd.
        #[clap(long, env = "FUSION_FNSD_HOME", display_order = 100)]
        home: Option<PathBuf>,
        ...
        #[clap(short, long, env = "FUSION_FNSD_GRPC_BIND", display_order = 201)]
        ...
        #[clap(
            short,
            long,
            env = "FUSION_FNSD_METRICS_BIND",
            default_value = "127.0.0.1:9000",
            display_order = 300
        )]
        metrics_bind: SocketAddr,
        /// The JSON-RPC address of the CometBFT node driving this `fnsd`
        /// instance.
        ///
        ...
        #[clap(
            short,
            long,
            env = "FUSION_FNSD_COMETBFT_PROXY_URL",
    ...
    Export {
        ...
        /// node state, e.g. ~/fnsd-backup.tar.gz.
    ...
    Migrate {
        ...
        /// CometBFT state alongside the auto-located `fnsd` state.
...
pub enum NetworkCommand {
    ...
    Generate {
        ...
        /// Fusion wallet address to include in genesis allocations.
        ...
        #[clap(long)]
        allocation_address: Option<fusion_keys::Address>,
        #[clap(long, parse(from_os_str))]
        ...
        /// so `--gas-price-simple=1000` means all resources will have a cost of 1ufusion.
        #[clap(long)]
    ...
    Join {
        ...
        #[clap(long, env = "FUSION_FNSD_ARCHIVE_URL")]
        archive_url: Option<Url>,
        /// Human-readable name to identify node on network
        // Default: 'node-#'
        #[clap(long, env = "FUSION_FNSD_TM_EXTERNAL_ADDR")]
