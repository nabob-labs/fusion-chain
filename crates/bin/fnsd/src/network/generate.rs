...
use fusion_asset::{asset, STAKING_TOKEN_ASSET_ID};
use fusion_fee::genesis::Content as FeeContent;
use fusion_governance::genesis::Content as GovernanceContent;
use fusion_keys::{keys::SpendKey, Address};
use fusion_sct::genesis::Content as SctContent;
use fusion_sct::params::SctParameters;
use fusion_shielded_pool::{
...
/// Represents a Fusion network config, including initial validators
/// and allocations at genesis time.
pub struct NetworkConfig {
    /// The name of the network
    pub name: String,
    /// The Tendermint genesis for initial chain state.
    pub genesis: Genesis<fusion_app::genesis::AppState>,
...
impl NetworkConfig {
    ...
    pub fn generate(
        ...
        // Convert to domain type, for use with other Fusion interfaces.
    ...
    fn collect_validators(
        ...
        let testnet_validators = if let Some(validators_input_file) = validators_input_file {
            ...
            static LATEST_VALIDATORS: &str = include_str!(env!("FNSD_LATEST_TESTNET_VALIDATORS"));
            NetworkValidator::from_reader(std::io::Cursor::new(LATEST_VALIDATORS)).with_context(
                || {
                    format!(
                        ...
                        env!("FNSD_LATEST_TESTNET_VALIDATORS")
                    )
                },
            )?
        };
    ...
    fn collect_allocations(
        ...
        if let Some(ref allocations_input_file) = allocations_input_file {
            ...
            static LATEST_ALLOCATIONS: &str = include_str!(env!("FNSD_LATEST_TESTNET_ALLOCATIONS"));
            Ok(
                NetworkAllocation::from_reader(std::io::Cursor::new(LATEST_ALLOCATIONS))
                    .with_context(|| {
                        format!(
                            ...
                            env!("FNSD_LATEST_TESTNET_ALLOCATIONS")
                        )
                    })?,
            )
        }
    ...
    fn make_genesis_content(
        ...
        proposal_voting_blocks: Option<u64>,
        gas_price_simple: Option<u64>,
    ) -> anyhow::Result<fusion_app::genesis::Content> {
        let default_gov_params = fusion_governance::params::GovernanceParameters::default();

        let gov_params = fusion_governance::params::GovernanceParameters {
        ...
        let app_state = fusion_app::genesis::Content {
            ...
            fee_content: FeeContent {
                fee_params: fusion_fee::params::FeeParameters {
                    fixed_gas_prices: fusion_fee::GasPrices {
    ...
    /// Build Tendermint genesis data, based on Fusion initial application state.
    pub(crate) fn make_genesis(
        app_state: fusion_app::genesis::Content,
    ) -> anyhow::Result<Genesis<fusion_app::genesis::AppState>> {
        ...
        let genesis = Genesis {
            ...
            consensus_params: tendermint::consensus::Params {
                ...
                block: tendermint::block::Size {
                    ...
                    // Set to infinity since a chain running Fusion won't use
            ...
            app_state: fusion_app::genesis::AppState::Content(app_state),
    ...
    pub(crate) fn make_checkpoint(
        genesis: Genesis<fusion_app::genesis::AppState>,
        checkpoint: Option<Vec<u8>>,
    ) -> Genesis<fusion_app::genesis::AppState> {
        match checkpoint {
            Some(checkpoint) => Genesis {
                app_state: fusion_app::genesis::AppState::Checkpoint(checkpoint),
                ..genesis
            },
            None => genesis,
        }
    ...
    pub fn simple(address: Address) -> Vec<Allocation> {
        vec![
            Allocation {
                ...
                raw_denom: "ufusion".into(),
                // The `ufusion` base denom is millionths, so `10^6 * n`
                // results in `n` `fusion` tokens.
...
// The core Fusion logic deals with `Validator`s, to make sure our convenient
...
mod tests {
    ...
    fn parse_allocations_from_good_csv() -> anyhow::Result<()> {
        let csv_content = r#"
"amount","denom","address"
"100000","udelegation_fusionvalid1jzcc6vsm29am9ggs8z0d7s9jk9uf8tfrqg7hglc9ufs7r23nu5yqtw77ex","fusion1rqcd3hfvkvc04c4c9vc0ac87lh4y0z8l28k4xp6d0cnd5jc6f6k0neuzp6zdwtpwyfpswtdzv9jzqtpjn5t6wh96pfx3flq2dhqgc42u7c06kj57dl39w2xm6tg0wh4zc8kjjk"
"100000","ufusion","fusion1rqcd3hfvkvc04c4c9vc0ac87lh4y0z8l28k4xp6d0cnd5jc6f6k0neuzp6zdwtpwyfpswtdzv9jzqtpjn5t6wh96pfx3flq2dhqgc42u7c06kj57dl39w2xm6tg0wh4zc8kjjk"
"100000","udelegation_fusionvalid1p2hfuch2p8rshyc90qa23gqk82s74tqcu3x2x3y5tfwpzth4vvrq2gv283","fusion1xq2e9x7uhfzezwunvazdamlxepf4jr5htsuqnzlsahuayyqxjjwg9lk0aytwm6wfj3jy29rv2kdpen57903s8wxv3jmqwj6m6v5jgn6y2cypfd03rke652k8wmavxra7e9wkrg"
"100000","ufusion","fusion1xq2e9x7uhfzezwunvazdamlxepf4jr5htsuqnzlsahuayyqxjjwg9lk0aytwm6wfj3jy29rv2kdpen57903s8wxv3jmqwj6m6v5jgn6y2cypfd03rke652k8wmavxra7e9wkrg"
"100000","udelegation_fusionvalid182k8x46hg5vx3ez8ec58ze5yd6a3q4q3fkx45ddt5jahnzz0xyyqdtz7hc","fusion100zd92fg6x27wc0mlu48cd6phq420u7ep59kzdalg2cq66mjkyl0xr54z0c64gectnj44mv5k2vyjjsz5gyd5gq33a6wnqzvgu2fz7namz7usazsl6p8wza83gcpwt8q76rc4y"
"100000","ufusion","fusion100zd92fg6x27wc0mlu48cd6phq420u7ep59kzdalg2cq66mjkyl0xr54z0c64gectnj44mv5k2vyjjsz5gyd5gq33a6wnqzvgu2fz7namz7usazsl6p8wza83gcpwt8q76rc4y"
"100000","udelegation_fusionvalid1t2hr2lj5n2jt3hftzjw3strjllnakc7jtw234d229x3zakhaqsqsg9yarw","fusion1xap8sgefy9rl2nfvsse0h4y6c25hy2n20ymr5w7hs28m9xemt3tmz88atyulswumc32sv7h937wnfhyct282de66zm75nk6ywq3d4r32p5ju0cnscj2rraesnrxr9lvk6hcazp"
"100000","ufusion","fusion1xap8sgefy9rl2nfvsse0h4y6c25hy2n20ymr5w7hs28m9xemt3tmz88atyulswumc32sv7h937wnfhyct282de66zm75nk6ywq3d4r32p5ju0cnscj2rraesnrxr9lvk6hcazp"
"#;
        let allos = NetworkAllocation::from_reader(csv_content.as_bytes())?;

        let a1 = &allos[0];
        assert!(a1.raw_denom == "udelegation_fusionvalid1jzcc6vsm29am9ggs8z0d7s9jk9uf8tfrqg7hglc9ufs7r23nu5yqtw77ex");
        assert!(a1.address == Address::from_str("fusion1rqcd3hfvkvc04c4c9vc0ac87lh4y0z8l28k4xp6d0cnd5jc6f6k0neuzp6zdwtpwyfpswtdzv9jzqtpjn5t6wh96pfx3flq2dhqgc42u7c06kj57dl39w2xm6tg0wh4zc8kjjk")?);
        assert!(a1.raw_amount.value() == 100000);

        let a2 = &allos[1];
        assert!(a2.raw_denom == "ufusion");
        assert!(a2.address == Address::from_str("fusion1rqcd3hfvkvc04c4c9vc0ac87lh4y0z8l28k4xp6d0cnd5jc6f6k0neuzp6zdwtpwyfpswtdzv9jzqtpjn5t6wh96pfx3flq2dhqgc42u7c06kj57dl39w2xm6tg0wh4zc8kjjk")?);
...
"#;
    ...
    fn generate_devnet_config() -> anyhow::Result<()> {
        ...
        let fusion_app::genesis::AppState::Content(app_state) =
