...
use fusion_stake::IdentityKey;

#[derive(Debug)]
pub struct GovernanceProposals {}

const EVENT_PROPOSAL_SUBMIT: &str = "fusion.core.component.governance.v1.EventProposalSubmit";
const EVENT_DELEGATOR_VOTE: &str = "fusion.core.component.governance.v1.EventDelegatorVote";
const EVENT_VALIDATOR_VOTE: &str = "fusion.core.component.governance.v1.EventValidatorVote";
const EVENT_PROPOSAL_WITHDRAW: &str = "fusion.core.component.governance.v1.EventProposalWithdraw";
const EVENT_PROPOSAL_PASSED: &str = "fusion.core.component.governance.v1.EventProposalPassed";
const EVENT_PROPOSAL_FAILED: &str = "fusion.core.component.governance.v1.EventProposalFailed";
const EVENT_PROPOSAL_SLASHED: &str = "fusion.core.component.governance.v1.EventProposalSlashed";
const EVENT_PROPOSAL_DEPOSIT_CLAIM: &str =
    "fusion.core.component.governance.v1.EventProposalDepositClaim";
