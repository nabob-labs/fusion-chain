...
use fusion_proto::{core::component::stake::v1 as pb, event::ProtoEvent};
use fusion_stake::{
...
impl ValidatorSet {
    async fn index_event(
        ...
        match event.event.kind.as_str() {
            "fusion.core.component.stake.v1.EventValidatorDefinitionUpload" => {
            ...
            "fusion.core.component.stake.v1.EventValidatorVotingPowerChange" => {
            ...
            "fusion.core.component.stake.v1.EventValidatorStateChange" => {
            ...
            "fusion.core.component.stake.v1.EventValidatorBondingStateChange" => {
