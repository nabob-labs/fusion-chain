    ...
    fn tag(&self) -> &'static str {
        match self {
            Self::InboundTransfer => {
                "fusion.core.component.shielded_pool.v1.EventInboundFungibleTokenTransfer"
            }
            Self::OutboundTransfer => {
                "fusion.core.component.shielded_pool.v1.EventOutboundFungibleTokenTransfer"
            }
            Self::OutboundRefund => {
                "fusion.core.component.shielded_pool.v1.EventOutboundFungibleTokenRefund"
            }
        }
    }
}
...
async fn create_transfer(
    ...
    sqlx::query("INSERT INTO ibc_transfer VALUES (DEFAULT, $7, $1, $6::NUMERIC(39, 0) * $2::NUMERIC(39, 0), $3, $4, $5)")
        ...
        .bind(transfer.fusion_addr.to_vec())
