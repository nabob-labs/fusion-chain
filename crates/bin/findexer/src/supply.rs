...
enum Event {
    ...
    DexArb {
        height: u64,
        swap_execution: fusion_dex::SwapExecution,
    },
    BlockFees {
        height: u64,
        total: fusion_fee::Fee,
    },
}

impl Event {
    const NAMES: [&'static str; 10] = [
        "fusion.core.component.stake.v1.EventUndelegate",
        "fusion.core.component.stake.v1.EventDelegate",
        "fusion.core.component.funding.v1.EventFundingStreamReward",
        "fusion.core.component.stake.v1.EventRateDataChange",
        "fusion.core.component.auction.v1.EventValueCircuitBreakerCredit",
        "fusion.core.component.auction.v1.EventValueCircuitBreakerDebit",
        "fusion.core.component.dex.v1.EventValueCircuitBreakerCredit",
        "fusion.core.component.dex.v1.EventValueCircuitBreakerDebit",
        "fusion.core.component.dex.v1.EventArbExecution",
        "fusion.core.component.fee.v1.EventBlockFees",
    ];
