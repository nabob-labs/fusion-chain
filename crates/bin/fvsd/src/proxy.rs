...
impl NamedService for AppQueryProxy {
    const NAME: &'static str = "fusion.core.app.v1.QueryService";
}
...
impl NamedService for GovernanceQueryProxy {
    const NAME: &'static str = "fusion.core.component.governance.v1.QueryService";
}
...
impl NamedService for DexQueryProxy {
    const NAME: &'static str = "fusion.core.component.dex.v1.QueryService";
}
...
impl NamedService for DexSimulationProxy {
    const NAME: &'static str = "fusion.core.component.dex.v1.SimulationService";
}
...
impl NamedService for FeeQueryProxy {
    const NAME: &'static str = "fusion.core.component.fee.v1.QueryService";
}
...
impl NamedService for SctQueryProxy {
    const NAME: &'static str = "fusion.core.component.sct.v1.QueryService";
}
...
impl NamedService for ShieldedPoolQueryProxy {
    const NAME: &'static str = "fusion.core.component.shielded_pool.v1.QueryService";
}
...
impl NamedService for ChainQueryProxy {
    const NAME: &'static str = "fusion.core.component.chain.v1.QueryService";
}
...
impl NamedService for StakeQueryProxy {
    const NAME: &'static str = "fusion.core.component.stake.v1.QueryService";
}
...
impl NamedService for CompactBlockQueryProxy {
    const NAME: &'static str = "fusion.core.component.compact_block.v1.QueryService";
}
...
impl NamedService for TendermintProxyProxy {
    const NAME: &'static str = "fusion.util.tendermint_proxy.v1.TendermintProxyService";
}
