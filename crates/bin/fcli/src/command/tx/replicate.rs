...
use linear::Linear;
use fusion_dex::DirectedUnitPair;
use fusion_proto::core::component::dex::v1::{
...
mod tests {
    ...
    fn test_adjust_price_by_exponents() {
        let pair1: DirectedUnitPair = "fusion:gm".parse().unwrap();
        let pair2: DirectedUnitPair = "ufusion:gm".parse().unwrap();
        let pair3: DirectedUnitPair = "fusion:ugm".parse().unwrap();
        let pair4: DirectedUnitPair = "ufusion:ugm".parse().unwrap();
