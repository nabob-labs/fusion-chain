...
use fusion_keys::keys::AddressIndex;
use fusion_num::Amount;
use fusion_proto::view::v1::GasPricesRequest;
use fusion_view::{Planner, ViewClient};
...
mod tests {
    ...
    #[test]
    fn sanity_check_fusion_gm_example() {
        let params = Linear {
            pair: "fusion:gm".parse().unwrap(),
        ...
        let asset_cache = fusion_asset::asset::Cache::with_known_assets();
