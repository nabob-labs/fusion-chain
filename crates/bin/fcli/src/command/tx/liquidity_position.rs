...
pub enum OrderCmd {
    Buy {
        /// The desired purchase, formatted as a string, e.g. `100fusion@1.2gm` would attempt
        /// to purchase 100 fusion at a price of 1.2 gm per 1fusion.
        ///
    ...
    Sell {
        /// The desired sale, formatted as a string, e.g. `100fusion@1.2gm` would attempt
        /// to sell 100 fusion at a price of 1.2 gm per 1fusion.
        ///
        /// An optional suffix of the form `/10bps` may be added to specify a fee spread for the
        /// resulting position, though this is less useful for buy/sell orders than passive LPs.
        sell_order: String,
