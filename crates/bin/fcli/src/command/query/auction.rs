...
use fusion_asset::asset::Cache;
use fusion_asset::Value;
use fusion_auction::auction::dutch::DutchAuction;
use fusion_auction::auction::AuctionId;
use fusion_dex::lp::position::{self, Position};
use fusion_num::fixpoint::U128x128;
use fusion_num::Amount;
use fusion_proto::core::component::auction::v1 as pb_auction;
use fusion_proto::core::component::auction::v1::query_service_client::QueryServiceClient as AuctionQueryServiceClient;
use fusion_proto::core::component::auction::v1::AuctionStateByIdRequest;
use fusion_proto::core::component::dex::v1::query_service_client::QueryServiceClient as DexQueryServiceClient;
use fusion_proto::core::component::dex::v1::LiquidityPositionByIdRequest;
use fusion_proto::DomainType;
use fusion_proto::Name;
use fusion_view::ViewClient;
    ...
    pub async fn exec(&self, app: &mut App) -> anyhow::Result<()> {
        match self {
            AuctionCmd::Dutch { auction_id } => {
                ...
                let mut auction_client = AuctionQueryServiceClient::new(app.fnsd_channel().await?);
                ...
                if pb_auction_state.type_url == pb_auction::DutchAuction::type_url() {
                    ...
                    let position = if let Some(position_id) = dutch_auction.state.current_position {
                        let mut dex_client = DexQueryServiceClient::new(app.fnsd_channel().await?);
