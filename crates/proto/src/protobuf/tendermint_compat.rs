...
//
//  NOTE: this submodule is tightly focused on helping `fusion-tendermint-proxy` function.
...
use crate::util::tendermint_proxy::v1 as fusion_pb;
use anyhow::anyhow;

// === get_tx ===

impl From<tendermint_rpc::endpoint::tx::Response> for fusion_pb::GetTxResponse {
    fn from(
...
impl From<tendermint::abci::types::ExecTxResult> for fusion_pb::TxResult {
    fn from(
        ...
        Self {
            ...
            tags: events
                ...
                .flat_map(|Event { attributes, .. }: Event| {
                    attributes.into_iter().map(fusion_pb::Tag::from)
                })
                .collect(),
        }
    }
...
impl From<tendermint::abci::EventAttribute> for fusion_pb::Tag {
...
// impl From<tendermint::abci::event::v0_37::EventAttribute> for fusion_pb::Tag {
//     fn from(
...
impl From<tendermint_rpc::endpoint::broadcast::tx_async::Response>
    for fusion_pb::BroadcastTxAsyncResponse
{
    fn from(
...
impl From<tendermint_rpc::endpoint::broadcast::tx_sync::Response>
    for fusion_pb::BroadcastTxSyncResponse
{
    fn from(
...
impl From<tendermint_rpc::endpoint::status::Response> for fusion_pb::GetStatusResponse {
    fn from(
...
impl From<tendermint_rpc::endpoint::status::SyncInfo> for fusion_pb::SyncInfo {
    fn from(
...
impl TryFrom<tendermint_rpc::endpoint::abci_query::AbciQuery>
    for fusion_pb::AbciQueryResponse
{
...
impl TryFrom<tendermint_rpc::endpoint::block::Response>
    for fusion_pb::GetBlockByHeightResponse
{
