...
pub mod validator_identity_key {
    ...
    pub const BECH32_PREFIX: &str = "fusionvalid";
...
pub mod validator_governance_key {
    ...
    pub const BECH32_PREFIX: &str = "fusiongovern";
...
pub mod address {
    ...
    pub const BECH32_PREFIX: &str = "fusion";
...
pub mod compat_address {
    ...
    pub const BECH32_PREFIX: &str = "fusioncompat1";
...
pub mod full_viewing_key {
    ...
    pub const BECH32_PREFIX: &str = "fusionfullviewingkey";
...
pub mod wallet_id {
    ...
    pub const BECH32_PREFIX: &str = "fusionwalletid";
...
pub mod spend_key {
    ...
    pub const BECH32_PREFIX: &str = "fusionspendkey";
