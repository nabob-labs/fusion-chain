impl serde::Serialize for DkgRound1Package {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.decaf377_frost.v1.DKGRound1Package", len)?;
...
impl<'de> serde::Deserialize<'de> for DkgRound1Package {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.decaf377_frost.v1.DKGRound1Package")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.decaf377_frost.v1.DKGRound1Package", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DkgRound2Package {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.decaf377_frost.v1.DKGRound2Package", len)?;
...
impl<'de> serde::Deserialize<'de> for DkgRound2Package {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.decaf377_frost.v1.DKGRound2Package")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.decaf377_frost.v1.DKGRound2Package", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NonceCommitment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.decaf377_frost.v1.NonceCommitment", len)?;
        if !self.element.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for NonceCommitment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.decaf377_frost.v1.NonceCommitment")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.decaf377_frost.v1.NonceCommitment", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SignatureShare {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.decaf377_frost.v1.SignatureShare", len)?;
        if !self.scalar.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for SignatureShare {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.decaf377_frost.v1.SignatureShare")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.decaf377_frost.v1.SignatureShare", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SigningCommitments {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.decaf377_frost.v1.SigningCommitments", len)?;
...
impl<'de> serde::Deserialize<'de> for SigningCommitments {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.decaf377_frost.v1.SigningCommitments")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.decaf377_frost.v1.SigningCommitments", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SigningShare {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.decaf377_frost.v1.SigningShare", len)?;
        if !self.scalar.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("scalar", pbjson::private::base64::encode(&self.scalar).as_str())?;
...
impl<'de> serde::Deserialize<'de> for SigningShare {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.decaf377_frost.v1.SigningShare")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.decaf377_frost.v1.SigningShare", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VerifiableSecretSharingCommitment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.decaf377_frost.v1.VerifiableSecretSharingCommitment", len)?;
        if !self.elements.is_empty() {
...
impl<'de> serde::Deserialize<'de> for VerifiableSecretSharingCommitment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.decaf377_frost.v1.VerifiableSecretSharingCommitment")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.decaf377_frost.v1.VerifiableSecretSharingCommitment", FIELDS, GeneratedVisitor)
    }
}
