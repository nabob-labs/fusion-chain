...
impl ::prost::Name for LqtCheckNullifierRequest {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.LqtCheckNullifierRequest".into()
    }
...
impl ::prost::Name for LqtCheckNullifierResponse {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.LqtCheckNullifierResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.LqtCheckNullifierResponse".into()
    }
...
pub mod funding_parameters {
    ...
    impl ::prost::Name for LiquidityTournament {
        ...
        const PACKAGE: &'static str = "fusion.core.component.funding.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.component.funding.v1.FundingParameters.LiquidityTournament"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.component.funding.v1.FundingParameters.LiquidityTournament"
...
impl ::prost::Name for FundingParameters {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.FundingParameters".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.FundingParameters".into()
    }
...
impl ::prost::Name for GenesisContent {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.GenesisContent".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.GenesisContent".into()
    }
...
impl ::prost::Name for EventFundingStreamReward {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.EventFundingStreamReward".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.EventFundingStreamReward".into()
    }
...
impl ::prost::Name for ActionLiquidityTournamentVote {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.ActionLiquidityTournamentVote".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.ActionLiquidityTournamentVote".into()
    }
...
impl ::prost::Name for LiquidityTournamentVoteBody {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.LiquidityTournamentVoteBody".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.LiquidityTournamentVoteBody".into()
    }
...
impl ::prost::Name for ActionLiquidityTournamentVotePlan {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.ActionLiquidityTournamentVotePlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.ActionLiquidityTournamentVotePlan".into()
    }
...
impl ::prost::Name for ZkLiquidityTournamentVoteProof {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.ZKLiquidityTournamentVoteProof".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.ZKLiquidityTournamentVoteProof".into()
    }
...
pub mod action_liquidity_tournament_vote_view {
    ...
    impl ::prost::Name for Visible {
        ...
        const PACKAGE: &'static str = "fusion.core.component.funding.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.component.funding.v1.ActionLiquidityTournamentVoteView.Visible"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.component.funding.v1.ActionLiquidityTournamentVoteView.Visible"
    ...
    impl ::prost::Name for Opaque {
        ...
        const PACKAGE: &'static str = "fusion.core.component.funding.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.component.funding.v1.ActionLiquidityTournamentVoteView.Opaque"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.component.funding.v1.ActionLiquidityTournamentVoteView.Opaque"
...
impl ::prost::Name for ActionLiquidityTournamentVoteView {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.ActionLiquidityTournamentVoteView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.ActionLiquidityTournamentVoteView".into()
    }
...
impl ::prost::Name for EventLqtDelegatorReward {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.EventLqtDelegatorReward".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.EventLqtDelegatorReward".into()
    }
...
impl ::prost::Name for EventLqtPositionReward {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.EventLqtPositionReward".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.EventLqtPositionReward".into()
    }
...
impl ::prost::Name for EventLqtVote {
    ...
    const PACKAGE: &'static str = "fusion.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.funding.v1.EventLqtVote".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.funding.v1.EventLqtVote".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/fusion.core.component.funding.v1.FundingService/LqtCheckNullifier",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "fusion.core.component.funding.v1.FundingService",
                        "LqtCheckNullifier",
                    ),
                );
...
pub mod funding_service_server {
    ...
    pub const SERVICE_NAME: &str = "fusion.core.component.funding.v1.FundingService";
