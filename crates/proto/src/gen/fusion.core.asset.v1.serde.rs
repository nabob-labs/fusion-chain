impl serde::Serialize for AssetId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.AssetId", len)?;
        if !self.inner.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AssetId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.AssetId")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.AssetId", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AssetImage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.AssetImage", len)?;
        if !self.png.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AssetImage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.AssetImage")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.AssetImage", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for asset_image::Theme {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.AssetImage.Theme", len)?;
        if !self.primary_color_hex.is_empty() {
...
impl<'de> serde::Deserialize<'de> for asset_image::Theme {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.AssetImage.Theme")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.AssetImage.Theme", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Balance {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.Balance", len)?;
        if !self.values.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Balance {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.Balance")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.Balance", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for balance::SignedValue {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.Balance.SignedValue", len)?;
...
impl<'de> serde::Deserialize<'de> for balance::SignedValue {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.Balance.SignedValue")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.Balance.SignedValue", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for BalanceCommitment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.BalanceCommitment", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for BalanceCommitment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.BalanceCommitment")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.BalanceCommitment", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Denom {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.Denom", len)?;
        if !self.denom.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Denom {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.Denom")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.Denom", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DenomUnit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.DenomUnit", len)?;
        if !self.denom.is_empty() {
            struct_ser.serialize_field("denom", &self.denom)?;
        }
        if self.exponent != 0 {
...
impl<'de> serde::Deserialize<'de> for DenomUnit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.DenomUnit")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.DenomUnit", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EquivalentValue {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.EquivalentValue", len)?;
...
impl<'de> serde::Deserialize<'de> for EquivalentValue {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.EquivalentValue")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.EquivalentValue", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EstimatedPrice {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.EstimatedPrice", len)?;
...
impl<'de> serde::Deserialize<'de> for EstimatedPrice {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.EstimatedPrice")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.EstimatedPrice", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Metadata {
        ...
        S: serde::Serializer,
    {
        ...
        if self.fusion_asset_id.is_some() {
            len += 1;
        }
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.Metadata", len)?;
        if !self.description.is_empty() {
        ...
        if let Some(v) = self.fusion_asset_id.as_ref() {
            struct_ser.serialize_field("fusionAssetId", v)?;
        }
        if !self.images.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Metadata {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "fusionAssetId" | "fusion_asset_id" => Ok(GeneratedField::FusionAssetId),
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.Metadata")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut fusion_asset_id__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::FusionAssetId => {
                            if fusion_asset_id__.is_some() {
                                return Err(serde::de::Error::duplicate_field("fusionAssetId"));
                            }
                            fusion_asset_id__ = map_.next_value()?;
                        }
                ...
                Ok(Metadata {
                    ...
                    fusion_asset_id: fusion_asset_id__,
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.Metadata", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Value {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.Value", len)?;
...
impl<'de> serde::Deserialize<'de> for Value {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.Value")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.Value", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValueView {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.ValueView", len)?;
...
impl<'de> serde::Deserialize<'de> for ValueView {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.ValueView")
            }
...
;
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.ValueView", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for value_view::KnownAssetId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.ValueView.KnownAssetId", len)?;
        if let Some(v) = self.amount.as_ref() {
            struct_ser.serialize_field("amount", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for value_view::KnownAssetId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.ValueView.KnownAssetId")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.ValueView.KnownAssetId", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for value_view::UnknownAssetId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.asset.v1.ValueView.UnknownAssetId", len)?;
        if let Some(v) = self.amount.as_ref() {
            struct_ser.serialize_field("amount", v)?;
        }
        if let Some(v) = self.asset_id.as_ref() {
...
impl<'de> serde::Deserialize<'de> for value_view::UnknownAssetId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.asset.v1.ValueView.UnknownAssetId")
            }
        ...
        deserializer.deserialize_struct("fusion.core.asset.v1.ValueView.UnknownAssetId", FIELDS, GeneratedVisitor)
    }
}
