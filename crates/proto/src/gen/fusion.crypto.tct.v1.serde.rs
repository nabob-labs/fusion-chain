impl serde::Serialize for MerklePathChunk {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.tct.v1.MerklePathChunk", len)?;
        if !self.sibling_1.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MerklePathChunk {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.tct.v1.MerklePathChunk")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.tct.v1.MerklePathChunk", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MerkleRoot {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.tct.v1.MerkleRoot", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for MerkleRoot {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.tct.v1.MerkleRoot")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.tct.v1.MerkleRoot", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StateCommitment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.tct.v1.StateCommitment", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for StateCommitment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.tct.v1.StateCommitment")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.tct.v1.StateCommitment", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StateCommitmentProof {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.crypto.tct.v1.StateCommitmentProof", len)?;
...
impl<'de> serde::Deserialize<'de> for StateCommitmentProof {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.crypto.tct.v1.StateCommitmentProof")
            }
        ...
        deserializer.deserialize_struct("fusion.crypto.tct.v1.StateCommitmentProof", FIELDS, GeneratedVisitor)
    }
}
