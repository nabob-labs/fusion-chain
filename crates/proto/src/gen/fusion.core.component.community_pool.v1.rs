...
impl ::prost::Name for CommunityPoolParameters {
    ...
    const PACKAGE: &'static str = "fusion.core.component.community_pool.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.community_pool.v1.CommunityPoolParameters".into()
    }
...
impl ::prost::Name for GenesisContent {
    ...
    const PACKAGE: &'static str = "fusion.core.component.community_pool.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.community_pool.v1.GenesisContent".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.community_pool.v1.GenesisContent".into()
    }
...
impl ::prost::Name for CommunityPoolAssetBalancesRequest {
    ...
    const PACKAGE: &'static str = "fusion.core.component.community_pool.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesRequest"
            .into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesRequest"
...
impl ::prost::Name for CommunityPoolAssetBalancesResponse {
    ...
    const PACKAGE: &'static str = "fusion.core.component.community_pool.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesResponse"
            .into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesResponse"
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/fusion.core.component.community_pool.v1.QueryService/CommunityPoolAssetBalances",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "fusion.core.component.community_pool.v1.QueryService",
...
pub mod query_service_server {
    ...
    pub const SERVICE_NAME: &str = "fusion.core.component.community_pool.v1.QueryService";
