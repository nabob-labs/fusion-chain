impl serde::Serialize for Address {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.Address", len)?;
        if !self.inner.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Address {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.Address")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.Address", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AddressIndex {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.AddressIndex", len)?;
        if self.account != 0 {
...
impl<'de> serde::Deserialize<'de> for AddressIndex {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.AddressIndex")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.AddressIndex", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AddressView {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.AddressView", len)?;
...
impl<'de> serde::Deserialize<'de> for AddressView {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.AddressView")
            }
...
;
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.AddressView", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for address_view::Decoded {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.AddressView.Decoded", len)?;
...
impl<'de> serde::Deserialize<'de> for address_view::Decoded {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.AddressView.Decoded")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.AddressView.Decoded", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for address_view::Opaque {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.AddressView.Opaque", len)?;
        if let Some(v) = self.address.as_ref() {
            struct_ser.serialize_field("address", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for address_view::Opaque {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.AddressView.Opaque")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.AddressView.Opaque", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ConsensusKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.ConsensusKey", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for ConsensusKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.ConsensusKey")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.ConsensusKey", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Diversifier {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.Diversifier", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for Diversifier {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.Diversifier")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.Diversifier", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FullViewingKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.FullViewingKey", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for FullViewingKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.FullViewingKey")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.FullViewingKey", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GovernanceKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.GovernanceKey", len)?;
        if !self.gk.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for GovernanceKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.GovernanceKey")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.GovernanceKey", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IdentityKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.IdentityKey", len)?;
        if !self.ik.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for IdentityKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.IdentityKey")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.IdentityKey", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PayloadKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.PayloadKey", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for PayloadKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.PayloadKey")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.PayloadKey", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SpendKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.SpendKey", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for SpendKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.SpendKey")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.SpendKey", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WalletId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.keys.v1.WalletId", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for WalletId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.keys.v1.WalletId")
            }
        ...
        deserializer.deserialize_struct("fusion.core.keys.v1.WalletId", FIELDS, GeneratedVisitor)
    }
}
