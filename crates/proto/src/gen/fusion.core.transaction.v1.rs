...
impl ::prost::Name for Transaction {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.Transaction".into()
    }
...
impl ::prost::Name for TransactionBody {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.TransactionBody".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.TransactionBody".into()
    }
...
impl ::prost::Name for TransactionParameters {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.TransactionParameters".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.TransactionParameters".into()
    }
...
pub mod transaction_summary {
    ...
    impl ::prost::Name for Effects {
        ...
        const PACKAGE: &'static str = "fusion.core.transaction.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.transaction.v1.TransactionSummary.Effects".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.transaction.v1.TransactionSummary.Effects".into()
        }
...
impl ::prost::Name for TransactionSummary {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.TransactionSummary".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.TransactionSummary".into()
    }
...
impl ::prost::Name for DetectionData {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.DetectionData".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.DetectionData".into()
    }
...
impl ::prost::Name for Action {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.Action".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.Action".into()
    }
...
pub mod transaction_perspective {
    ...
    impl ::prost::Name for ExtendedMetadataById {
        ...
        const PACKAGE: &'static str = "fusion.core.transaction.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.transaction.v1.TransactionPerspective.ExtendedMetadataById"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.transaction.v1.TransactionPerspective.ExtendedMetadataById"
    ...
    impl ::prost::Name for CreationTransactionIdByNullifier {
        ...
        const PACKAGE: &'static str = "fusion.core.transaction.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.transaction.v1.TransactionPerspective.CreationTransactionIdByNullifier"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.transaction.v1.TransactionPerspective.CreationTransactionIdByNullifier"
    ...
    impl ::prost::Name for NullificationTransactionIdByCommitment {
        ...
        const PACKAGE: &'static str = "fusion.core.transaction.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.transaction.v1.TransactionPerspective.NullificationTransactionIdByCommitment"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.transaction.v1.TransactionPerspective.NullificationTransactionIdByCommitment"
...
impl ::prost::Name for TransactionPerspective {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.TransactionPerspective".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.TransactionPerspective".into()
    }
...
impl ::prost::Name for PayloadKeyWithCommitment {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.PayloadKeyWithCommitment".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.PayloadKeyWithCommitment".into()
    }
...
impl ::prost::Name for NullifierWithNote {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.NullifierWithNote".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.NullifierWithNote".into()
    }
}
/// View of a Fusion transaction.
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl ::prost::Name for TransactionView {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.TransactionView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.TransactionView".into()
    }
...
impl ::prost::Name for TransactionBodyView {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.TransactionBodyView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.TransactionBodyView".into()
    }
...
impl ::prost::Name for ActionView {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.ActionView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.ActionView".into()
    }
...
impl ::prost::Name for AuthorizationData {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.AuthorizationData".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.AuthorizationData".into()
    }
...
impl ::prost::Name for WitnessData {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.WitnessData".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.WitnessData".into()
    }
...
impl ::prost::Name for TransactionPlan {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.TransactionPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.TransactionPlan".into()
    }
...
impl ::prost::Name for DetectionDataPlan {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.DetectionDataPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.DetectionDataPlan".into()
    }
...
impl ::prost::Name for ActionPlan {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.ActionPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.ActionPlan".into()
    }
...
impl ::prost::Name for CluePlan {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.CluePlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.CluePlan".into()
    }
...
impl ::prost::Name for MemoPlan {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.MemoPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.MemoPlan".into()
    }
...
impl ::prost::Name for MemoCiphertext {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.MemoCiphertext".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.MemoCiphertext".into()
    }
...
impl ::prost::Name for MemoPlaintext {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.MemoPlaintext".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.MemoPlaintext".into()
    }
...
impl ::prost::Name for MemoPlaintextView {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.MemoPlaintextView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.MemoPlaintextView".into()
    }
...
pub mod memo_view {
    ...
    impl ::prost::Name for Visible {
        ...
        const PACKAGE: &'static str = "fusion.core.transaction.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.transaction.v1.MemoView.Visible".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.transaction.v1.MemoView.Visible".into()
        }
    ...
    impl ::prost::Name for Opaque {
        ...
        const PACKAGE: &'static str = "fusion.core.transaction.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "fusion.core.transaction.v1.MemoView.Opaque".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/fusion.core.transaction.v1.MemoView.Opaque".into()
        }
...
impl ::prost::Name for MemoView {
    ...
    const PACKAGE: &'static str = "fusion.core.transaction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.transaction.v1.MemoView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.transaction.v1.MemoView".into()
    }
