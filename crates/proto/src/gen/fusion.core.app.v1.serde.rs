impl serde::Serialize for AppParameters {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.app.v1.AppParameters", len)?;
        if !self.chain_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AppParameters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.app.v1.AppParameters")
            }
        ...
        deserializer.deserialize_struct("fusion.core.app.v1.AppParameters", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AppParametersRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("fusion.core.app.v1.AppParametersRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for AppParametersRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.app.v1.AppParametersRequest")
            }
        ...
        deserializer.deserialize_struct("fusion.core.app.v1.AppParametersRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AppParametersResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.app.v1.AppParametersResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for AppParametersResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.app.v1.AppParametersResponse")
            }
        ...
        deserializer.deserialize_struct("fusion.core.app.v1.AppParametersResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventAppParametersChange {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.app.v1.EventAppParametersChange", len)?;
...
impl<'de> serde::Deserialize<'de> for EventAppParametersChange {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.app.v1.EventAppParametersChange")
            }
        ...
        deserializer.deserialize_struct("fusion.core.app.v1.EventAppParametersChange", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisAppState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.app.v1.GenesisAppState", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisAppState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.app.v1.GenesisAppState")
            }
...
;
        ...
        deserializer.deserialize_struct("fusion.core.app.v1.GenesisAppState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.app.v1.GenesisContent", len)?;
        if !self.chain_id.is_empty() {
            struct_ser.serialize_field("chainId", &self.chain_id)?;
        }
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.app.v1.GenesisContent")
            }
        ...
        deserializer.deserialize_struct("fusion.core.app.v1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TransactionsByHeightRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.app.v1.TransactionsByHeightRequest", len)?;
        if self.block_height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for TransactionsByHeightRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.app.v1.TransactionsByHeightRequest")
            }
        ...
        deserializer.deserialize_struct("fusion.core.app.v1.TransactionsByHeightRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TransactionsByHeightResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.app.v1.TransactionsByHeightResponse", len)?;
        if !self.transactions.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TransactionsByHeightResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.app.v1.TransactionsByHeightResponse")
            }
        ...
        deserializer.deserialize_struct("fusion.core.app.v1.TransactionsByHeightResponse", FIELDS, GeneratedVisitor)
    }
}
