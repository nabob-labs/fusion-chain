impl serde::Serialize for Amount {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.num.v1.Amount", len)?;
        if self.lo != 0 {
...
impl<'de> serde::Deserialize<'de> for Amount {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.num.v1.Amount")
            }
        ...
        deserializer.deserialize_struct("fusion.core.num.v1.Amount", FIELDS, GeneratedVisitor)
    }
}
