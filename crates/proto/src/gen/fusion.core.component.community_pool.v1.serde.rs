impl serde::Serialize for CommunityPoolAssetBalancesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesRequest", len)?;
        if !self.asset_ids.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CommunityPoolAssetBalancesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesRequest")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CommunityPoolAssetBalancesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for CommunityPoolAssetBalancesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesResponse")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.community_pool.v1.CommunityPoolAssetBalancesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CommunityPoolParameters {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.community_pool.v1.CommunityPoolParameters", len)?;
        if self.community_pool_spend_proposals_enabled {
...
impl<'de> serde::Deserialize<'de> for CommunityPoolParameters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.community_pool.v1.CommunityPoolParameters")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.community_pool.v1.CommunityPoolParameters", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.community_pool.v1.GenesisContent", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.community_pool.v1.GenesisContent")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.community_pool.v1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
