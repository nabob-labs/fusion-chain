impl serde::Serialize for CurrentGasPricesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.CurrentGasPricesRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CurrentGasPricesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.CurrentGasPricesRequest")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.CurrentGasPricesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CurrentGasPricesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.CurrentGasPricesResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for CurrentGasPricesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.CurrentGasPricesResponse")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.CurrentGasPricesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventBlockFees {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.EventBlockFees", len)?;
...
impl<'de> serde::Deserialize<'de> for EventBlockFees {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.EventBlockFees")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.EventBlockFees", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventPaidFee {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.EventPaidFee", len)?;
...
impl<'de> serde::Deserialize<'de> for EventPaidFee {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.EventPaidFee")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.EventPaidFee", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Fee {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.Fee", len)?;
...
impl<'de> serde::Deserialize<'de> for Fee {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.Fee")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.Fee", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FeeParameters {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.FeeParameters", len)?;
...
impl<'de> serde::Deserialize<'de> for FeeParameters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.FeeParameters")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.FeeParameters", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FeeTier {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.FeeTier", len)?;
        if self.fee_tier != 0 {
...
impl<'de> serde::Deserialize<'de> for FeeTier {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.FeeTier")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.FeeTier", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Gas {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.Gas", len)?;
        if self.block_space != 0 {
...
impl<'de> serde::Deserialize<'de> for Gas {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.Gas")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.Gas", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GasPrices {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.GasPrices", len)?;
        if let Some(v) = self.asset_id.as_ref() {
            struct_ser.serialize_field("assetId", v)?;
        }
        if self.block_space_price != 0 {
...
impl<'de> serde::Deserialize<'de> for GasPrices {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.GasPrices")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.GasPrices", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.fee.v1.GenesisContent", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.fee.v1.GenesisContent")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.fee.v1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
