...
impl ::prost::Name for AuctionParameters {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.AuctionParameters".into()
    }
...
impl ::prost::Name for GenesisContent {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.GenesisContent".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.GenesisContent".into()
    }
...
impl ::prost::Name for AuctionStateByIdRequest {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.AuctionStateByIdRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.AuctionStateByIdRequest".into()
    }
...
impl ::prost::Name for AuctionStateByIdResponse {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.AuctionStateByIdResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.AuctionStateByIdResponse".into()
    }
...
impl ::prost::Name for AuctionStateByIdsRequest {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.AuctionStateByIdsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.AuctionStateByIdsRequest".into()
    }
...
impl ::prost::Name for AuctionStateByIdsResponse {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.AuctionStateByIdsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.AuctionStateByIdsResponse".into()
    }
...
impl ::prost::Name for AuctionId {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.AuctionId".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.AuctionId".into()
    }
...
impl ::prost::Name for AuctionNft {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.AuctionNft".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.AuctionNft".into()
    }
...
impl ::prost::Name for DutchAuctionDescription {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.DutchAuctionDescription".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.DutchAuctionDescription".into()
    }
...
impl ::prost::Name for DutchAuctionState {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.DutchAuctionState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.DutchAuctionState".into()
    }
...
impl ::prost::Name for DutchAuction {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.DutchAuction".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.DutchAuction".into()
    }
...
impl ::prost::Name for ActionDutchAuctionSchedule {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.ActionDutchAuctionSchedule".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.ActionDutchAuctionSchedule".into()
    }
...
impl ::prost::Name for ActionDutchAuctionEnd {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.ActionDutchAuctionEnd".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.ActionDutchAuctionEnd".into()
    }
...
impl ::prost::Name for ActionDutchAuctionWithdraw {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.ActionDutchAuctionWithdraw".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.ActionDutchAuctionWithdraw".into()
    }
...
impl ::prost::Name for ActionDutchAuctionWithdrawPlan {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.ActionDutchAuctionWithdrawPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.ActionDutchAuctionWithdrawPlan".into()
    }
...
impl ::prost::Name for ActionDutchAuctionScheduleView {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.ActionDutchAuctionScheduleView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.ActionDutchAuctionScheduleView".into()
    }
...
impl ::prost::Name for ActionDutchAuctionWithdrawView {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.ActionDutchAuctionWithdrawView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.ActionDutchAuctionWithdrawView".into()
    }
...
impl ::prost::Name for EventDutchAuctionScheduled {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.EventDutchAuctionScheduled".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.EventDutchAuctionScheduled".into()
    }
...
impl ::prost::Name for EventDutchAuctionUpdated {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.EventDutchAuctionUpdated".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.EventDutchAuctionUpdated".into()
    }
...
impl ::prost::Name for EventDutchAuctionEnded {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.EventDutchAuctionEnded".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.EventDutchAuctionEnded".into()
    }
...
impl ::prost::Name for EventDutchAuctionWithdrawn {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.EventDutchAuctionWithdrawn".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.EventDutchAuctionWithdrawn".into()
    }
...
impl ::prost::Name for EventValueCircuitBreakerCredit {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.EventValueCircuitBreakerCredit".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.EventValueCircuitBreakerCredit".into()
    }
...
impl ::prost::Name for EventValueCircuitBreakerDebit {
    ...
    const PACKAGE: &'static str = "fusion.core.component.auction.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.component.auction.v1.EventValueCircuitBreakerDebit".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.component.auction.v1.EventValueCircuitBreakerDebit".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/fusion.core.component.auction.v1.QueryService/AuctionStateById",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "fusion.core.component.auction.v1.QueryService",
                        "AuctionStateById",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/fusion.core.component.auction.v1.QueryService/AuctionStateByIds",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod query_service_server {
    ...
    pub const SERVICE_NAME: &str = "fusion.core.component.auction.v1.QueryService";
