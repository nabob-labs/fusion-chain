...
impl ::prost::Name for StateCommitment {
    ...
    const PACKAGE: &'static str = "fusion.crypto.tct.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.crypto.tct.v1.StateCommitment".into()
    }
...
impl ::prost::Name for MerkleRoot {
    ...
    const PACKAGE: &'static str = "fusion.crypto.tct.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.crypto.tct.v1.MerkleRoot".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.crypto.tct.v1.MerkleRoot".into()
    }
...
impl ::prost::Name for StateCommitmentProof {
    ...
    const PACKAGE: &'static str = "fusion.crypto.tct.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.crypto.tct.v1.StateCommitmentProof".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.crypto.tct.v1.StateCommitmentProof".into()
    }
...
impl ::prost::Name for MerklePathChunk {
    ...
    const PACKAGE: &'static str = "fusion.crypto.tct.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.crypto.tct.v1.MerklePathChunk".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.crypto.tct.v1.MerklePathChunk".into()
    }
