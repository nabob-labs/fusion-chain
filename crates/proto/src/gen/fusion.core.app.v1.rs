...
impl ::prost::Name for TransactionsByHeightRequest {
    ...
    const PACKAGE: &'static str = "fusion.core.app.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.app.v1.TransactionsByHeightRequest".into()
    }
...
impl ::prost::Name for TransactionsByHeightResponse {
    ...
    const PACKAGE: &'static str = "fusion.core.app.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.app.v1.TransactionsByHeightResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.app.v1.TransactionsByHeightResponse".into()
    }
...
impl ::prost::Name for AppParameters {
    ...
    const PACKAGE: &'static str = "fusion.core.app.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.app.v1.AppParameters".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.app.v1.AppParameters".into()
    }
...
impl ::prost::Name for AppParametersRequest {
    ...
    const PACKAGE: &'static str = "fusion.core.app.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.app.v1.AppParametersRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.app.v1.AppParametersRequest".into()
    }
...
impl ::prost::Name for AppParametersResponse {
    ...
    const PACKAGE: &'static str = "fusion.core.app.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.app.v1.AppParametersResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.app.v1.AppParametersResponse".into()
    }
...
impl ::prost::Name for GenesisAppState {
    ...
    const PACKAGE: &'static str = "fusion.core.app.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.app.v1.GenesisAppState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.app.v1.GenesisAppState".into()
    }
...
impl ::prost::Name for GenesisContent {
    ...
    const PACKAGE: &'static str = "fusion.core.app.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.app.v1.GenesisContent".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.app.v1.GenesisContent".into()
    }
...
impl ::prost::Name for EventAppParametersChange {
    ...
    const PACKAGE: &'static str = "fusion.core.app.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.app.v1.EventAppParametersChange".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.app.v1.EventAppParametersChange".into()
    }
...
pub mod query_service_client {
    ...
    /// Query operations for the overall Fusion application.
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/fusion.core.app.v1.QueryService/AppParameters",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("fusion.core.app.v1.QueryService", "AppParameters"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/fusion.core.app.v1.QueryService/TransactionsByHeight",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "fusion.core.app.v1.QueryService",
...
pub mod query_service_server {
    ...
    pub const SERVICE_NAME: &str = "fusion.core.app.v1.QueryService";
