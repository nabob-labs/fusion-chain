impl serde::Serialize for CompactBlock {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.CompactBlock", len)?;
        if self.height != 0 {
...
impl<'de> serde::Deserialize<'de> for CompactBlock {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.CompactBlock")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.CompactBlock", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CompactBlockRangeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.CompactBlockRangeRequest", len)?;
        if self.start_height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for CompactBlockRangeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.CompactBlockRangeRequest")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.CompactBlockRangeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CompactBlockRangeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.CompactBlockRangeResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for CompactBlockRangeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.CompactBlockRangeResponse")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.CompactBlockRangeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CompactBlockRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.CompactBlockRequest", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for CompactBlockRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.CompactBlockRequest")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.CompactBlockRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CompactBlockResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.CompactBlockResponse", len)?;
        if let Some(v) = self.compact_block.as_ref() {
            struct_ser.serialize_field("compactBlock", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for CompactBlockResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.CompactBlockResponse")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.CompactBlockResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StatePayload {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.StatePayload", len)?;
...
impl<'de> serde::Deserialize<'de> for StatePayload {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.StatePayload")
            }
...
;
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.StatePayload", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for state_payload::Note {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.StatePayload.Note", len)?;
...
impl<'de> serde::Deserialize<'de> for state_payload::Note {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.StatePayload.Note")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.StatePayload.Note", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for state_payload::RolledUp {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.StatePayload.RolledUp", len)?;
...
impl<'de> serde::Deserialize<'de> for state_payload::RolledUp {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.StatePayload.RolledUp")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.StatePayload.RolledUp", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for state_payload::Swap {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.compact_block.v1.StatePayload.Swap", len)?;
...
impl<'de> serde::Deserialize<'de> for state_payload::Swap {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.compact_block.v1.StatePayload.Swap")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.compact_block.v1.StatePayload.Swap", FIELDS, GeneratedVisitor)
    }
}
