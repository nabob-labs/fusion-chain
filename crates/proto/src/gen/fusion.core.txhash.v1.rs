...
/// The hash of a Fusion transaction's *effecting data*, describing the effects
...
impl ::prost::Name for EffectHash {
    ...
    const PACKAGE: &'static str = "fusion.core.txhash.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.txhash.v1.EffectHash".into()
    }
...
impl ::prost::Name for TransactionId {
    ...
    const PACKAGE: &'static str = "fusion.core.txhash.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.core.txhash.v1.TransactionId".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.core.txhash.v1.TransactionId".into()
    }
