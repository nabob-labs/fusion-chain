impl serde::Serialize for CoordinatorRound1 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.CoordinatorRound1", len)?;
...
impl<'de> serde::Deserialize<'de> for CoordinatorRound1 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.CoordinatorRound1")
            }
...
;
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.CoordinatorRound1", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CoordinatorRound2 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.CoordinatorRound2", len)?;
        if !self.signing_packages.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CoordinatorRound2 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.CoordinatorRound2")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.CoordinatorRound2", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for coordinator_round2::IdentifiedCommitments {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.CoordinatorRound2.IdentifiedCommitments", len)?;
        if !self.identifier.is_empty() {
...
impl<'de> serde::Deserialize<'de> for coordinator_round2::IdentifiedCommitments {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.CoordinatorRound2.IdentifiedCommitments")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.CoordinatorRound2.IdentifiedCommitments", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for coordinator_round2::PartialSigningPackage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.CoordinatorRound2.PartialSigningPackage", len)?;
        if !self.all_commitments.is_empty() {
...
impl<'de> serde::Deserialize<'de> for coordinator_round2::PartialSigningPackage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.CoordinatorRound2.PartialSigningPackage")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.CoordinatorRound2.PartialSigningPackage", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DkgRound1 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.DKGRound1", len)?;
...
impl<'de> serde::Deserialize<'de> for DkgRound1 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.DKGRound1")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.DKGRound1", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DkgRound2 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.DKGRound2", len)?;
...
impl<'de> serde::Deserialize<'de> for DkgRound2 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.DKGRound2")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.DKGRound2", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for dkg_round2::Inner {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.DKGRound2.Inner", len)?;
        if !self.encrypted_packages.is_empty() {
...
impl<'de> serde::Deserialize<'de> for dkg_round2::Inner {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.DKGRound2.Inner")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.DKGRound2.Inner", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for dkg_round2::TargetedPackage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.DKGRound2.TargetedPackage", len)?;
        if !self.vk.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("vk", pbjson::private::base64::encode(&self.vk).as_str())?;
...
impl<'de> serde::Deserialize<'de> for dkg_round2::TargetedPackage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.DKGRound2.TargetedPackage")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.DKGRound2.TargetedPackage", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FollowerRound1 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.FollowerRound1", len)?;
        if let Some(v) = self.inner.as_ref() {
            struct_ser.serialize_field("inner", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for FollowerRound1 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.FollowerRound1")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.FollowerRound1", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for follower_round1::Inner {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.FollowerRound1.Inner", len)?;
        if !self.commitments.is_empty() {
...
impl<'de> serde::Deserialize<'de> for follower_round1::Inner {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.FollowerRound1.Inner")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.FollowerRound1.Inner", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FollowerRound2 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.FollowerRound2", len)?;
        if let Some(v) = self.inner.as_ref() {
            struct_ser.serialize_field("inner", v)?;
        }
        if let Some(v) = self.pk.as_ref() {
...
impl<'de> serde::Deserialize<'de> for FollowerRound2 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.FollowerRound2")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.FollowerRound2", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for follower_round2::Inner {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.FollowerRound2.Inner", len)?;
        if !self.shares.is_empty() {
...
impl<'de> serde::Deserialize<'de> for follower_round2::Inner {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.FollowerRound2.Inner")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.FollowerRound2.Inner", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Signature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.Signature", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for Signature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.Signature")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.Signature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VerificationKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.custody.threshold.v1.VerificationKey", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
...
impl<'de> serde::Deserialize<'de> for VerificationKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.custody.threshold.v1.VerificationKey")
            }
        ...
        deserializer.deserialize_struct("fusion.custody.threshold.v1.VerificationKey", FIELDS, GeneratedVisitor)
    }
}
