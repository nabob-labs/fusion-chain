...
impl ::prost::Name for SpendAuthSignature {
    ...
    const PACKAGE: &'static str = "fusion.crypto.decaf377_rdsa.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.crypto.decaf377_rdsa.v1.SpendAuthSignature".into()
    }
...
impl ::prost::Name for BindingSignature {
    ...
    const PACKAGE: &'static str = "fusion.crypto.decaf377_rdsa.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.crypto.decaf377_rdsa.v1.BindingSignature".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.crypto.decaf377_rdsa.v1.BindingSignature".into()
    }
...
impl ::prost::Name for SpendVerificationKey {
    ...
    const PACKAGE: &'static str = "fusion.crypto.decaf377_rdsa.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "fusion.crypto.decaf377_rdsa.v1.SpendVerificationKey".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/fusion.crypto.decaf377_rdsa.v1.SpendVerificationKey".into()
    }
