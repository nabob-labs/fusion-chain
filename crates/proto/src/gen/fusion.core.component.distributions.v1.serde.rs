impl serde::Serialize for CurrentLqtPoolSizeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("fusion.core.component.distributions.v1.CurrentLqtPoolSizeRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CurrentLqtPoolSizeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.distributions.v1.CurrentLqtPoolSizeRequest")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.distributions.v1.CurrentLqtPoolSizeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CurrentLqtPoolSizeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.distributions.v1.CurrentLqtPoolSizeResponse", len)?;
        if self.epoch_index != 0 {
...
impl<'de> serde::Deserialize<'de> for CurrentLqtPoolSizeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.distributions.v1.CurrentLqtPoolSizeResponse")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.distributions.v1.CurrentLqtPoolSizeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DistributionsParameters {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.distributions.v1.DistributionsParameters", len)?;
        if self.staking_issuance_per_block != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for DistributionsParameters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.distributions.v1.DistributionsParameters")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.distributions.v1.DistributionsParameters", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventLqtPoolSizeIncrease {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.distributions.v1.EventLqtPoolSizeIncrease", len)?;
        if self.epoch != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for EventLqtPoolSizeIncrease {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.distributions.v1.EventLqtPoolSizeIncrease")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.distributions.v1.EventLqtPoolSizeIncrease", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.distributions.v1.GenesisContent", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.distributions.v1.GenesisContent")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.distributions.v1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LqtPoolSizeByEpochRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.distributions.v1.LqtPoolSizeByEpochRequest", len)?;
        if self.epoch != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&self.epoch).as_str())?;
...
impl<'de> serde::Deserialize<'de> for LqtPoolSizeByEpochRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.distributions.v1.LqtPoolSizeByEpochRequest")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.distributions.v1.LqtPoolSizeByEpochRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LqtPoolSizeByEpochResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.core.component.distributions.v1.LqtPoolSizeByEpochResponse", len)?;
        if self.epoch_index != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epochIndex", ToString::to_string(&self.epoch_index).as_str())?;
...
impl<'de> serde::Deserialize<'de> for LqtPoolSizeByEpochResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.core.component.distributions.v1.LqtPoolSizeByEpochResponse")
            }
        ...
        deserializer.deserialize_struct("fusion.core.component.distributions.v1.LqtPoolSizeByEpochResponse", FIELDS, GeneratedVisitor)
    }
}
