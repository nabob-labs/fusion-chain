impl serde::Serialize for CeremonyCrs {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.CeremonyCrs", len)?;
        if !self.spend.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CeremonyCrs {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.CeremonyCrs")
            }
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.CeremonyCrs", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CeremonyLinkingProof {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.CeremonyLinkingProof", len)?;
        if !self.spend.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("spend", pbjson::private::base64::encode(&self.spend).as_str())?;
...
impl<'de> serde::Deserialize<'de> for CeremonyLinkingProof {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.CeremonyLinkingProof")
            }
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.CeremonyLinkingProof", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CeremonyParentHashes {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.CeremonyParentHashes", len)?;
        if !self.spend.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("spend", pbjson::private::base64::encode(&self.spend).as_str())?;
...
impl<'de> serde::Deserialize<'de> for CeremonyParentHashes {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.CeremonyParentHashes")
            }
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.CeremonyParentHashes", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ParticipateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.ParticipateRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for ParticipateRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.ParticipateRequest")
            }
...
;
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.ParticipateRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_request::Contribution {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.ParticipateRequest.Contribution", len)?;
...
impl<'de> serde::Deserialize<'de> for participate_request::Contribution {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.ParticipateRequest.Contribution")
            }
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.ParticipateRequest.Contribution", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_request::Identify {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.ParticipateRequest.Identify", len)?;
...
impl<'de> serde::Deserialize<'de> for participate_request::Identify {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.ParticipateRequest.Identify")
            }
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.ParticipateRequest.Identify", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ParticipateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.ParticipateResponse", len)?;
        if let Some(v) = self.msg.as_ref() {
            match v {
...
impl<'de> serde::Deserialize<'de> for ParticipateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.ParticipateResponse")
            }
...
;
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.ParticipateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_response::Confirm {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.ParticipateResponse.Confirm", len)?;
        if self.slot != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for participate_response::Confirm {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.ParticipateResponse.Confirm")
            }
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.ParticipateResponse.Confirm", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_response::ContributeNow {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.ParticipateResponse.ContributeNow", len)?;
...
impl<'de> serde::Deserialize<'de> for participate_response::ContributeNow {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.ParticipateResponse.ContributeNow")
            }
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.ParticipateResponse.ContributeNow", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_response::Position {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("fusion.tools.summoning.v1.ParticipateResponse.Position", len)?;
        if self.position != 0 {
...
impl<'de> serde::Deserialize<'de> for participate_response::Position {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct fusion.tools.summoning.v1.ParticipateResponse.Position")
            }
        ...
        deserializer.deserialize_struct("fusion.tools.summoning.v1.ParticipateResponse.Position", FIELDS, GeneratedVisitor)
    }
}
