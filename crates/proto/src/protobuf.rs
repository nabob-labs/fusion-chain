...
// that shouldn't depend on the Fusion proto framework.

use crate::fusion::core::component::ibc::v1::IbcRelay;
use crate::fusion::crypto::decaf377_rdsa::v1::{
...
use crate::fusion::crypto::decaf377_fmd::v1::Clue as ProtoClue;
...
use crate::fusion::core::keys::v1::ConsensusKey;

impl DomainType for tendermint::PublicKey {
    type Proto = ConsensusKey;
}

impl From<tendermint::PublicKey> for crate::fusion::core::keys::v1::ConsensusKey {
