...
use fusion_tct::{r1cs::StateCommitmentVar, StateCommitment};
use poseidon377::hash_3;

use once_cell::sync::Lazy;
use fusion_keys::keys::{NullifierKey, NullifierKeyVar};
use fusion_proto::{core::component::sct::v1 as pb, DomainType};
...
pub static NULLIFIER_DOMAIN_SEP: Lazy<Fq> = Lazy::new(|| {
    Fq::from_le_bytes_mod_order(blake2b_simd::blake2b(b"fusion.nullifier").as_bytes())
});
