...
use fusion_dex::component::SwapDataRead;
use fusion_fee::component::StateReadExt as _;
use fusion_governance::StateReadExt as _;
use fusion_proto::DomainType;
use fusion_sct::component::clock::EpochRead;
use fusion_sct::component::tree::{SctManager as _, SctRead};
...
trait Inner: StateWrite {
    ...
    async fn finalize_compact_block(&mut self, end_epoch: bool) -> Result<()> {
        use fusion_shielded_pool::component::StateReadExt as _;
        ...
        // if they have (this is signaled by `fusion_fee::StateWriteExt::put_gas_prices`):
