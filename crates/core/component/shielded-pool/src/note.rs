...
use fusion_proto::fusion::core::component::shielded_pool::v1 as pb;
...
pub use fusion_tct::StateCommitment;

use fusion_asset::{asset, balance, Value, ValueView};
...
pub(crate) static NOTECOMMIT_DOMAIN_SEP: Lazy<Fq> = Lazy::new(|| {
    Fq::from_le_bytes_mod_order(blake2b_simd::blake2b(b"fusion.notecommit").as_bytes())
});
...
impl Note {
    ...
    pub fn decrypt_with_payload_key(
        ...
        // Ephemeral public key integrity check. See ZIP 212 or Fusion issue #1688.
