...
use fusion_proto::{
    fusion::core::component::ibc::v1::{self as pb, FungibleTokenPacketData},
    DomainType,
};
...
use fusion_ibc::component::packet::{IBCPacket, Unchecked};
...
pub struct Ics20Withdrawal {
    ...
    // a "sender" fusion address to use to return funds from this withdrawal.
    // this should be an ephemeral address
    pub return_address: Address,
    // the height (on Fusion) at which this transfer expires (and funds are sent
