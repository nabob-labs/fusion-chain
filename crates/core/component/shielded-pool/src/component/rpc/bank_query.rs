...
use fusion_asset::asset::{self, Metadata};
use fusion_ibc::component::state_key as ibc_state_key;
use fusion_num::Amount;
use fusion_proto::StateReadProto as _;
...
impl BankQuery for Server {
    ...
    /// Internally-minted assets (Fusion tokens, LP tokens, delegation tokens, etc.)
    ...
    async fn balance(
        ...
        Err(tonic::Status::unimplemented(
            "not implemented, fusion is a shielded chain",
        ))
    }
