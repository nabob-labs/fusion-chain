...
use fusion_dex::component::{PositionManager, PositionRead, StateReadExt as _};
use fusion_dex::lp::position::{self, Position};
use fusion_dex::lp::Reserves;
use fusion_dex::DirectedTradingPair;
use fusion_num::Amount;
use fusion_proto::core::component::auction::v1 as pb;
...
pub(crate) trait DutchAuctionData: StateRead {
    async fn stream_dutch_ids_by_trigger(
        ...
        use fusion_proto::StateReadProto;
