...
pub const DEX_PATH_SEARCH_DURATION: &str = "fusion_dex_path_search_duration_seconds";
pub const DEX_PATH_SEARCH_RELAX_PATH_DURATION: &str =
    "fusion_dex_path_search_relax_path_duration_seconds";
pub const DEX_ROUTE_FILL_DURATION: &str = "fusion_dex_route_fill_duration_seconds";
pub const DEX_ARB_DURATION: &str = "fusion_dex_arb_duration_seconds";
pub const DEX_BATCH_DURATION: &str = "fusion_dex_batch_duration_seconds";
pub const DEX_RPC_SIMULATE_TRADE_DURATION: &str =
    "fusion_dex_rpc_simulate_trade_duration_seconds";
