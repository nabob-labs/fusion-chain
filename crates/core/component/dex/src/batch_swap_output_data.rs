...
use fusion_proto::{fusion::core::component::dex::v1 as pb, DomainType};
use fusion_tct::Position;
use serde::{Deserialize, Serialize};

use fusion_num::fixpoint::{bit_constrain, U128x128, U128x128Var};
...
mod tests {
    ...
    use fusion_proof_params::{generate_test_parameters, DummyWitness};
    use rand_core::OsRng;
        ...
        fn with_dummy_witness() -> Self {
            let trading_pair = TradingPair {
                asset_1: asset::Cache::with_known_assets()
                    .get_unit("ufusion")
                    .expect("ufusion denom should always be known by the asset registry")
                    .id(),
