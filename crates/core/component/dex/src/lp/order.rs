...
impl BuyOrder {
    ...
    pub fn parse_str(input: &str) -> Result<Self> {
        ...
        // In, e.g., 100mfusion@1.2gm, we're expressing the desire to:
        // - buy 100_000 ufusion (absolute value)
        // - at a price of 1.2 gm per mfusion
        // So, our offered amount is 1.2 gm * 100 = 120 gm, or
        // 1_200_000 ugm * (100_000 ufusion / 1_000 (mfusion per ufusion)).
...
impl SellOrder {
    ...
    pub fn parse_str(input: &str) -> Result<Self> {
        ...
        // In, e.g., 100mfusion@1.2gm, we're expressing the desire to:
        // - sell 100_000 ufusion (absolute value)
        // - at a price of 1.2 gm per mfusion
