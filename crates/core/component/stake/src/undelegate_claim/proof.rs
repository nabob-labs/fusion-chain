...
use base64::prelude::*;
use fusion_proto::{core::component::stake::v1 as pb, DomainType};

use decaf377::{Fq, Fr};
use fusion_asset::{asset, balance, STAKING_TOKEN_ASSET_ID};
use fusion_num::Amount;
use fusion_proof_params::VerifyingKeyExt;
use fusion_shielded_pool::{ConvertProof, ConvertProofPrivate, ConvertProofPublic};
...
mod tests {
    ...
    use fusion_shielded_pool::ConvertCircuit;
