//! Fusion validators and related structures.

use fusion_keys::Address;
use fusion_proto::{fusion::core::component::stake::v1 as pb, DomainType};
...
/// Describes a Fusion validator's configuration data.
///
