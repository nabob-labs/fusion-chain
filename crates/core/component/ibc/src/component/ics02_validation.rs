...
// validate the parameters of an AnyClientState, verifying that it is a valid Fusion client
// state.
pub fn validate_fusion_sdk_client_state(
    client_state: Any,
    chain_id: &str,
    current_height: u64,
) -> anyhow::Result<()> {
    ...
    // check client proof specs match fusion proof specs
