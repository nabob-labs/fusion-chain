...
/// The ICS23 proof spec for fusion's IBC state; this can be used to verify proofs
/// for other substores in the fusion state, provided that the data is indeed inside a substore
