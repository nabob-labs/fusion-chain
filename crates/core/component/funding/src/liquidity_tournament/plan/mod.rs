...
use fusion_proof_params::DELEGATOR_VOTE_PROOF_PROVING_KEY;
use fusion_proto::{core::component::funding::v1 as pb, DomainType};
use fusion_sct::Nullifier;
use fusion_shielded_pool::note::Note;
use fusion_tct::{self as tct};
