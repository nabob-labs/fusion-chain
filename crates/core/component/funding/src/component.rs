...
impl Component for Funding {
    ...
    async fn end_epoch<S: StateWrite + 'static>(state: &mut Arc<S>) -> Result<()> {
        ...
        use fusion_community_pool::StateWriteExt as _;
        use fusion_distributions::component::StateReadExt as _;
        use fusion_sct::CommitmentSource;
        use fusion_shielded_pool::component::NoteManager;
        use fusion_stake::funding_stream::Recipient;
        use fusion_stake::StateReadExt as _;
