...
pub fn register_metrics() {
    ...
    fusion_stake::component::register_metrics();
    fusion_funding::component::register_metrics();
    fusion_dex::component::register_metrics();
    // TODO: this should be under component::
    fusion_governance::register_metrics();
    fusion_ibc::component::register_metrics();
    fusion_shielded_pool::component::register_metrics();
...
pub const MEMPOOL_CHECKTX_TOTAL: &str = "fusion_fnsd_mempool_checktx_total";
