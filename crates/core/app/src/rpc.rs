...
use {
    ...
    fusion_auction::component::rpc::Server as AuctionServer,
    fusion_compact_block::component::rpc::Server as CompactBlockServer,
    fusion_dex::component::rpc::Server as DexServer,
    fusion_fee::component::rpc::Server as FeeServer,
    fusion_governance::component::rpc::Server as GovernanceServer,
    fusion_proto::{
        core::{
    ...
    fusion_sct::component::rpc::Server as SctServer,
    fusion_shielded_pool::component::rpc::Server as ShieldedPoolServer,
    fusion_stake::component::rpc::Server as StakeServer,
...
pub fn routes(
    ...
    let ibc = fusion_ibc::component::rpc::IbcQuery::<FusionHost>::new(storage.clone());
    ...
    builder
        ...
        .add_service(we(tonic_reflection::server::Builder::configure()
            .register_encoded_file_descriptor_set(fusion_proto::FILE_DESCRIPTOR_SET)
            .build_v1()
