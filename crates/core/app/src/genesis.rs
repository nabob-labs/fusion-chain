use fusion_auction::genesis::Content as AuctionContent;
use fusion_community_pool::genesis::Content as CommunityPoolContent;
use fusion_dex::genesis::Content as DexContent;
use fusion_distributions::genesis::Content as DistributionsContent;
use fusion_fee::genesis::Content as FeeContent;
use fusion_funding::genesis::Content as FundingContent;
use fusion_governance::genesis::Content as GovernanceContent;
use fusion_ibc::genesis::Content as IBCContent;
use fusion_proto::{fusion::core::app::v1 as pb, DomainType};
use fusion_sct::genesis::Content as SctContent;
use fusion_shielded_pool::genesis::Content as ShieldedPoolContent;
use fusion_stake::genesis::Content as StakeContent;
...
impl Content {
    ...
    pub fn with_epoch_duration(self, epoch_duration: u64) -> Self {
        Self {
            sct_content: fusion_sct::genesis::Content {
                sct_params: fusion_sct::params::SctParameters { epoch_duration },
            },
            ..self
        }
    }
    ...
    pub fn with_unbonding_delay(self, unbonding_delay: u64) -> Self {
        Self {
            stake_content: fusion_stake::genesis::Content {
                stake_params: fusion_stake::params::StakeParameters {
                    unbonding_delay,
