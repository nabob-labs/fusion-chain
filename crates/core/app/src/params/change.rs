...
use anyhow::Context;
use anyhow::Result;
use fusion_auction::params::AuctionParameters;
use fusion_community_pool::params::CommunityPoolParameters;
use fusion_dex::DexParameters;
use fusion_distributions::params::DistributionsParameters;
use fusion_fee::FeeParameters;
use fusion_funding::params::FundingParameters;
use fusion_governance::change::ParameterChange;
use fusion_governance::{params::GovernanceParameters, tally::Ratio};
use fusion_ibc::params::IBCParameters;
use fusion_sct::params::SctParameters;
use fusion_shielded_pool::params::ShieldedPoolParameters;
use fusion_stake::params::StakeParameters;
        ...
        check_all([
            ...
            (
                *min_validator_stake >= 1_000_000u128.into(),
                "the minimum validator stake must be at least 1fusion",
            ),
        ])
    }
}
