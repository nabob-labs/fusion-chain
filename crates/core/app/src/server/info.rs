...
use fusion_ibc::component::ChannelStateReadExt as _;
use fusion_ibc::component::ClientStateReadExt as _;
use fusion_ibc::component::ConnectionStateReadExt as _;
...
use fusion_tower_trace::v037::RequestExt;
...
impl Info {
    ...
    async fn info(&self, info: request::Info) -> anyhow::Result<response::Info> {
        ...
        let last_block_height = FusionHost::get_block_height(&state)
            .await
