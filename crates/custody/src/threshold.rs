...
use fusion_transaction::AuthorizationData;
use rand_core::OsRng;
use serde::Serialize;
use tonic::{async_trait, Request, Response, Status};

use fusion_keys::{keys::AddressIndex, Address, FullViewingKey};
use fusion_proto::{custody::v1 as pb, DomainType};
...
mod test {
    ...
    use fusion_transaction::TransactionPlan;
        ...
        const TEST_PLAN: &'static str = r#"
{
    ...
    "transactionParameters": {
        "chainId": "fusion-testnet-rhea-8b2dfc5c",
        "fee": {
            "amount": {}
        }
    },
