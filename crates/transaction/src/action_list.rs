...
use fusion_fee::{Fee, FeeTier, Gas, GasPrices};
use fusion_keys::Address;
use fusion_num::Amount;
use fusion_shielded_pool::{fmd, OutputPlan};
...
impl ActionList {
    ...
    ///
    /// Because Fusion transactions have static gas costs, and gas use is linear in the actions,
