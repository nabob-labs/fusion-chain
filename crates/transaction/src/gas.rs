...
pub fn spend_gas_cost() -> Gas {
    Gas {
        // fusion.core.asset.v1.BalanceCommitment `balance_commitment`  = 32 bytes
        // fusion.core.component.sct.v1.Nullifier `nullifier`           = 32 bytes
        // fusion.crypto.decaf377_rdsa.v1.SpendVerificationKey `rk`     = 32 bytes
        // fusion.crypto.decaf377_rdsa.v1.SpendAuthSignature `auth_sig` = 64 bytes
...
fn undelegate_claim_gas_cost() -> Gas {
    Gas {
        // fusion.core.keys.v1.IdentityKey `validator_identity`         = 32 bytes
...
fn swap_gas_cost() -> Gas {
    Gas {
        ...
        // fusion.core.num.v1.Amount `delta_1_i`                   = 16 bytes
        // fusion.core.num.v1.Amount `delta_2_i`                   = 16 bytes
        // fusion.core.asset.v1.BalanceCommitment `fee_commitment` = 32 bytes
...
pub fn swap_claim_gas_cost() -> Gas {
    Gas {
        // fusion.core.component.sct.v1.Nullifier `nullifier`           = 32 bytes
        // fusion.core.component.fee.v1.Fee `fee``                      = 48 bytes
        // fusion.crypto.tct.v1.StateCommitment `output_1_commitment``  = 32 bytes
        // fusion.crypto.tct.v1.StateCommitment `output_2_commitment`   = 32 bytes
...
fn delegator_vote_gas_cost() -> Gas {
    Gas {
        ...
        // Vote `vote`                                                      = 1 byte
        // fusion.core.asset.v1.Value `value`                             = 48 bytes
        // fusion.core.num.v1.Amount `unbonded_amount`                    = 16 bytes
        // fusion.core.component.sct.v1.Nullifier `nullifier`             = 32 bytes
        // fusion.crypto.decaf377_rdsa.v1.SpendVerificationKey `rk`       = 32 bytes
        // fusion.crypto.decaf377_rdsa.v1.SpendAuthSignature `auth_sig`   = 64 bytes
...
fn position_withdraw_gas_cost() -> Gas {
    Gas {
        ...
        // fusion.core.asset.v1.BalanceCommitment `reserves_commitment`  = 32 bytes
...
fn dutch_auction_schedule_gas_cost(dutch_action_schedule: &ActionDutchAuctionSchedule) -> Gas {
    Gas {
        // fusion.core.asset.v1.Value `input` = 48 bytes
        // fusion.core.asset.v1.AssetId `output_id` = 32 bytes
        // fusion.core.num.v1.Amount `max_output` = 16 bytes
        // fusion.core.num.v1.Amount `min_output` = 16 bytes
