...
use fusion_txhash::AuthorizingData;
...
impl TransactionPlan {
    ...
    pub fn witness_data(&self, sct: &fusion_tct::Tree) -> Result<WitnessData, anyhow::Error> {
        let anchor = sct.root();

        let witness_note = |spend: &fusion_shielded_pool::SpendPlan| {
