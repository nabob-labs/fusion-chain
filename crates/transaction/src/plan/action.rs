...
use fusion_auction::auction::dutch::actions::ActionDutchAuctionEnd;
use fusion_auction::auction::dutch::actions::ActionDutchAuctionSchedule;
use fusion_auction::auction::dutch::actions::ActionDutchAuctionWithdrawPlan;
...
use fusion_keys::{symmetric::PayloadKey, FullViewingKey};
use fusion_proto::{core::transaction::v1 as pb_t, DomainType};
use fusion_shielded_pool::{Ics20Withdrawal, OutputPlan, SpendPlan};
use fusion_stake::{Delegate, Undelegate, UndelegateClaimPlan};
...
impl From<fusion_stake::validator::Definition> for ActionPlan {
    fn from(inner: fusion_stake::validator::Definition) -> ActionPlan {
        ...
        match msg {
            ...
            ActionPlan::PositionWithdraw(inner) => pb_t::ActionPlan {
                action: Some(pb_t::action_plan::Action::PositionWithdraw(Into::<
                    fusion_proto::core::component::dex::v1::PositionWithdrawPlan,
                >::into(
                    inner
                ))),
            },
